...
struct OrderedNamedBarriers {
    ...
    CUTE_DEVICE
    void
    init(int wg_idx) {  // wg_idx in among all WG participants
    ...
    CUTE_DEVICE
    void
    ordered_or_wait(int wg_idx) {  // wg_idx in participants
    ...
    CUTE_DEVICE
    void
    notify_next_blocked(int wg_idx) {  // wg_idx in participants
